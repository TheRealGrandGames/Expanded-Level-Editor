...
namespace BaldiLevelEditor
{
    ...
    public partial class PlusLevelEditor : Singleton<PlusLevelEditor>
    {
        ...
        public EditorLevel level = new EditorLevel(60, 60); //WAS 50, 50
        ...
        public void LoadTempPlay()
        {
            ...
            BaldiLevelEditorPlugin.coreGamePrefab.currentFieldTrip = GameObject.FindObjectOfType<FieldTripObject>();
            BaldiLevelEditorPlugin.coreGamePrefab.tripAvailable = true;
