...
namespace BaldiLevelEditor
{
    ...
    public class EditorLevel : Level
    {
        ...
        private RoomProperties _hallRoom_SaloonWall;
        ...
        public RoomProperties hallRoom_SaloonWall => _hallRoom_SaloonWall;
        public EditorLevel(byte width, byte height) : base(width, height)
        {
            ...
            AddRoom(_hallRoom);
            _hallRoom_SaloonWall = new RoomProperties("hall_saloonwall");
            _hallRoom_SaloonWall.textures = new TextureContainer(defaultTextures["hall_saloonwall"]);
            AddRoom(_hallRoom_SaloonWall);
        }

        void InitializeDefaultTextures()
        {
            defaultTextures.Add("hall", new TextureContainer("HallFloor", "Wall", "Ceiling"));
            //defaultTextures.Add("hall_carpet", new TextureContainer("BlueCarpet", "Wall", "Ceiling"));
            //defaultTextures.Add("hall_tiles", new TextureContainer("Actual", "Wall", "Ceiling"));

            defaultTextures.Add("hall_saloonwall", new TextureContainer("HallFloor", "SaloonWallEditor", "Ceiling"));
            //defaultTextures.Add("hall_saloonwall_carpet", new TextureContainer("BlueCarpet", "SaloonWall", "Ceiling"));
            //defaultTextures.Add("hall_saloonwall_tiles", new TextureContainer("Actual", "SaloonWall", "Ceiling"));
            ...
            defaultTextures.Add("closet_carpet", new TextureContainer("BlueCarpet", "Wall", "Ceiling"));
        ...
        public static EditorLevel LoadFromStream(BinaryReader reader)
        {
            ...
            level.RemoveRoomInternal(level._hallRoom_SaloonWall);
            level._hallRoom_SaloonWall = level.rooms.Find(x => x.type == "hall_saloonwall");
